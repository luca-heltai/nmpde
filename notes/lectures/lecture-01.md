...
```{figure} ../assets/generated/lecture-01-poisson-mesh.svg
:alt: Uniformly refined mesh for the model Poisson problem
:name: fig:lecture-01-poisson-mesh

Mesh generated by the course test suite.
```
